...
Soy estudiante de **Desarrollo de Aplicaciones Web (DAW)** en el Institut Les Salines. Me apasiona:

- 💻 El desarrollo backend con **PHP** y **JavaScript**
- 🧪 Los tests automáticos y la integración continua
...
| **Frameworks** | Laravel (aprendiendo), React (básico) |
| **Herramientas** | Git, GitHub Actions, Composer, PHPUnit |
